...
OPTION( phaseprob1, 100, 0, 1000, "ls best") \
OPTION( phaseprob2, 300, 0, 1000, "ls mediation") \
OPTION( phaseprob3, 300, 0, 1000, "ls target") \
OPTION( phaseprob4, 50 , 0, 1000, "invert now") \
OPTION( phaseprob5, 25 , 0, 1000, "invert best") \
OPTION( phaseprob6, 25 , 0, 1000, "invert mediation") \
OPTION( phaseprob7, 150, 0, 1000, "random") \
...
OPTION( targetinc, 0, 0, 1, "enable targetinc") \
